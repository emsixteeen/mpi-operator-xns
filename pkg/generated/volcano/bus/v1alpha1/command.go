...
func NewCommandInformer(client versioned.Interface, namespaces informers.NamespaceSet,
	resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredCommandInformer(client, namespaces, resyncPeriod, indexers, nil)
}

// NewFilteredCommandInformer constructs a new informer for Command type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredCommandInformer(client versioned.Interface, namespaces informers.NamespaceSet,
...
func (f *commandInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredCommandInformer(client, f.namespaces, resyncPeriod,
