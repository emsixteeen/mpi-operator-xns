...
func NewNumatopologyInformer(client versioned.Interface,
...
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredNumatopologyInformer(client versioned.Interface,
...
func (f *numatopologyInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredNumatopologyInformer(client, resyncPeriod,
