...
import (
	...
	volcanobatch "github.com/emsixteeen/mpi-operator-xns/pkg/generated/volcano/batch"
	volcanobus "github.com/emsixteeen/mpi-operator-xns/pkg/generated/volcano/bus"
	volcanoflow "github.com/emsixteeen/mpi-operator-xns/pkg/generated/volcano/flow"
	volcanonodeinfo "github.com/emsixteeen/mpi-operator-xns/pkg/generated/volcano/nodeinfo"
	volcanoscheduling "github.com/emsixteeen/mpi-operator-xns/pkg/generated/volcano/scheduling"
...
func (f *sharedInformerFactory) Batch() batch.Interface {
	return volcanobatch.New(f, f.namespaces, f.tweakListOptions)
}

func (f *sharedInformerFactory) Bus() bus.Interface {
	return volcanobus.New(f, f.namespaces, f.tweakListOptions)
}

func (f *sharedInformerFactory) Flow() flow.Interface {
	return volcanoflow.New(f, f.namespaces, f.tweakListOptions)
}

func (f *sharedInformerFactory) Nodeinfo() nodeinfo.Interface {
	return volcanonodeinfo.New(f, f.namespaces, f.tweakListOptions)
}

func (f *sharedInformerFactory) Scheduling() scheduling.Interface {
	return volcanoscheduling.New(f, f.namespaces, f.tweakListOptions)
}
