...
func NewJobTemplateInformer(client versioned.Interface, namespaces informers.NamespaceSet,
	resyncPeriod time.Duration, indexers cache.Indexers) cache.SharedIndexInformer {
	return NewFilteredJobTemplateInformer(client, namespaces, resyncPeriod, indexers, nil)
}

// NewFilteredJobTemplateInformer constructs a new informer for JobTemplate type.
// Always prefer using an informer factory to get a shared informer instead of getting an independent
// one. This reduces memory footprint and number of connections to the server.
func NewFilteredJobTemplateInformer(client versioned.Interface, namespaces informers.NamespaceSet,
...
func (f *jobTemplateInformer) defaultInformer(client versioned.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
	return NewFilteredJobTemplateInformer(client, f.namespaces, resyncPeriod,
