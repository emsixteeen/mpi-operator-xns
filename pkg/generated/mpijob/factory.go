...
import (
	...
	mpijobkubeflow "github.com/emsixteeen/mpi-operator-xns/pkg/generated/mpijob/kubeflow"
	versioned "github.com/kubeflow/mpi-operator/pkg/client/clientset/versioned"
	externalversions "github.com/kubeflow/mpi-operator/pkg/client/informers/externalversions"
...
func (f *sharedInformerFactory) Kubeflow() kubeflow.Interface {
	return mpijobkubeflow.New(f, f.namespaces, f.tweakListOptions)
}
