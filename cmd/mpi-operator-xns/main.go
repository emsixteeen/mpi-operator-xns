...
func main() {
	...
	s.Namespaces = NamespaceParser
	s.KubeInformer = MultiKubeInformer
	s.MpiJobInformer = MultiMpiJobInformer
	s.VolcanoInformer = MultiVolcanoInformer
	s.SchedulerPluginsInformer = MultiSchedulerPluginsInformer
